...
- Corpus, as of September 2026: 5 525 files, 5 516 rendered every page, zero
  crashes.
- The workspace stands at 4 653 passed / 0 failed / 56 ignored across 213
  suites (Windows x86_64, 15 September 2026, measured on the branch that added
  the region row). See [verification](../verification.md), whose own total is
  a separate dated measurement and moves when the lanes in flight merge.

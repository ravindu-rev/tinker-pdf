...
| --- | --- | --- | --- |
| 01 | [CFF glyph selection](01-cff-glyph-selection.md) | The character code is used as the glyph index. Code 65 fetches GID 65 | L |
| 02 | [CID to GID](02-cid-to-gid.md) | The CID is computed for widths and not for outlines. Wrong glyphs at correct spacing | M |

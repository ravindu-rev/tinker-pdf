...
Numbers on this page were measured in August 2026, except the fuzz sessions and the corpus attributions below, which are 5-6 September 2026, and the suite total, which is 26 September 2026. `cargo test --workspace`
is **5 159 passed, 0 failed, 60 ignored** across 227 suites on
`x86_64-unknown-linux-gnu`, measured on `develop` with the first wave of the
26 September batch merged — ZIP method 14, JPEG 2000 comic pages, XHTML's
...
<!-- Generated by `cargo run -p xtask -- fuzz --table`. 39 targets, 413 seeds. -->
...
| `xml` | 13 | 1 byte | unsignatured |
| `zip_archive` | 6 | 1 byte | 6/6 carried |

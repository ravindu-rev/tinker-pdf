...
<!-- Generated by `cargo run -p xtask -- fuzz --table`. 39 targets, 397 seeds. -->

| Target | Seeds | Control prefix | Signature check |
| --- | ---: | ---: | --- |
| `ascii_filters` | 6 | â€” | unsignatured |
| `brotli` | 46 | 1 byte | unsignatured |
| `ccitt` | 12 | 2 bytes | unsignatured |
| `cff` | 4 | â€” | unsignatured |
| `cff_subset` | 4 | â€” | unsignatured |
| `cmap` | 12 | â€” | unsignatured |
| `content_tokenizer` | 6 | â€” | unsignatured |
| `cos_document` | 8 | â€” | 8/8 carried |
| `cos_object` | 7 | â€” | unsignatured |
| `crypt` | 7 | â€” | unsignatured |
| `crypt_ciphers` | 4 | 2 bytes | unsignatured |
| `css` | 7 | 1 byte | unsignatured |
| `form_script` | 18 | â€” | unsignatured |
| `icc_profile` | 6 | â€” | 6/6 carried |
| `inflate` | 4 | â€” | unsignatured |
| `jbig2` | 22 | 1 byte | unsignatured |
| `jpeg` | 4 | â€” | 4/4 carried |
| `jpx` | 25 | 1 byte | 25/25 carried |
| `jxr` | 42 | 1 byte | 42/42 carried |
| `layout` | 6 | 2 bytes | unsignatured |
| `lzw` | 3 | â€” | unsignatured |
| `pki_cms` | 10 | â€” | unsignatured |
| `pki_der` | 12 | â€” | unsignatured |
| `png` | 5 | 1 byte | 5/5 carried |
| `rar` | 7 | 1 byte | 7/7 carried |
| `render_page` | 14 | â€” | unsignatured |
| `sevenz` | 7 | 1 byte | 7/7 carried |
| `sfnt` | 5 | â€” | 5/5 carried |
| `shape` | 8 | 2 bytes | unsignatured |
| `shape_text` | 5 | 2 bytes | unsignatured |
| `signatures` | 5 | â€” | unsignatured |
| `svg` | 17 | 1 byte | unsignatured |
| `tar` | 7 | 1 byte | 7/7 carried |
| `tiff` | 6 | 1 byte | 6/6 carried |
| `truetype` | 4 | â€” | 4/4 carried |
| `type1` | 2 | â€” | unsignatured |
| `woff` | 13 | â€” | 13/13 carried |
